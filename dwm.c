...
drawbar(Monitor *m)
{
	...
	/* Correction for statuscolors patch */
 	int correct = 0; 
	...
	if (m == selmon) { /* status is only drawn on selected monitor */
		...
		/* sw = TEXTW(stext) - lrpad + 2; 2px right padding (disabled) */
		sw = TEXTW(stext) - lrpad + 0 - correct; /* 2px right padding and correction for escape sequences */
		while (1) {
